...
describe('dashboardDraftMerge - pure merge', () => {
...
// Keep the schema constant referenced so lint does not drop the import when
// fixtures inline createEmptyDashboardDraftState only.
void DASHBOARD_DRAFT_SCHEMA_VERSION;
